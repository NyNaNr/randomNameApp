  ...
  return (
    <>
      <button
        ...
        z-50 h-7 w-7 hover:text-gray-400 text-white dark:text-white dark:hover:text-gray-300 sm:top-20 sm:left-[270px] sm:h-8 sm:w-8 sm:text-neutral-700 animate-flash`}
        onClick={onClick}
      >
        <ArrowBarLeft />
      </button>
  ...
  return (
    <button
      className={`fixed top-20 left-2
       ...
       sm:h-8 sm:w-8 sm:text-neutral-700 animate-flash`}
      onClick={onClick}
    >
      <ArrowBarRight />
    </button>
